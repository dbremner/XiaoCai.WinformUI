    ...
    partial class DockPanel
    {
        private static class Persistor
        {
            ...
            public static void SaveAsXml(DockPanel dockPanel, Stream stream, Encoding encoding, bool upstream)
            {
                ...
                xmlOut.WriteComment(XiaoCai.WinformUI.Properties.Resources.DockPanel_Persistor_XmlFileComment1);
                xmlOut.WriteComment(XiaoCai.WinformUI.Properties.Resources.DockPanel_Persistor_XmlFileComment2);
