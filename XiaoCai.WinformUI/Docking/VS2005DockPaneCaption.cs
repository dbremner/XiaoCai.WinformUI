...
namespace XiaoCai.WinformUI.Docking
{
	internal class VS2005DockPaneCaption : DockPaneCaptionBase
	{
        ...
        {
            m_buttonClose.ForeColor = TextColor;
        }
        ...
        private InertButton ButtonAutoHide
        {
            get
            {
                if (m_buttonAutoHide == null)
                {
                    ...
                    m_buttonAutoHide.MouseHover += new EventHandler(m_buttonAutoHide_MouseHover);
                    m_buttonAutoHide.MouseLeave += new EventHandler(m_buttonAutoHide_MouseLeave);
        ...
        void m_buttonAutoHide_MouseLeave(object sender, EventArgs e)
        {
            m_buttonAutoHide.ForeColor = TextColor;
        }

        void m_buttonAutoHide_MouseHover(object sender, EventArgs e)
        {
            m_buttonAutoHide.ForeColor = Color.FromArgb(255, 255, 200, 138);
        }
		...
		private static string ToolTipClose
		{
			...
			{	
				if (_toolTipClose == null)
                    _toolTipClose = XiaoCai.WinformUI.Properties.Resources.DockPaneCaption_ToolTipClose;
        ...
        private static string ToolTipOptions
        {
            get
            {
                if (_toolTipOptions == null)
                    _toolTipOptions = XiaoCai.WinformUI.Properties.Resources.DockPaneCaption_ToolTipOptions;
		...
		private static string ToolTipAutoHide
		{
			...
			{	
				if (_toolTipAutoHide == null)
                    _toolTipAutoHide = XiaoCai.WinformUI.Properties.Resources.DockPaneCaption_ToolTipAutoHide;
