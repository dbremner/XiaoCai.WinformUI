        ...
        private class SplitterControl : Control, ISplitterDragSource
        {
            ...
            protected override void OnPaint(PaintEventArgs e)
            {
                ...
                if (Alignment == DockAlignment.Top || Alignment == DockAlignment.Bottom)
                    ...
                    //g.DrawLine(new Pen(Color.Red), rect.Left, rect.Bottom - 1, rect.Right, rect.Bottom - 1);
                    ...
                    //g.DrawLine(new Pen(Color.Red), rect.Right - 1, rect.Top, rect.Right - 1, rect.Bottom);
