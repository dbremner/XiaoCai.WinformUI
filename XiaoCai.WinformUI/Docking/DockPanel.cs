...
namespace XiaoCai.WinformUI.Docking
{
    ...
    [ToolboxBitmap(typeof(resfinder), "XiaoCai.WinformUI.Docking.DockPanel.bmp")]
    ...
    public partial class DockPanel : Panel,IStyle
	{
        ...
        private Color _backColor=Color.PowderBlue;
	    ...
	    internal Form ParentForm
		{
			...
			{	
				if (!IsParentFormValid())
                    throw new InvalidOperationException(XiaoCai.WinformUI.Properties.Resources.DockPanel_ParentForm_Invalid);
