...
namespace XiaoCai.WinformUI.Docking
{
	internal class VS2005DockPaneStrip : DockPaneStripBase
	{
        ...
        private InertButton ButtonClose
        {
            get
            {
                if (m_buttonClose == null)
                {
                    ...
                    m_buttonClose.MouseHover+= new EventHandler(m_buttonClose_MouseHover);
                    m_buttonClose.MouseLeave += new EventHandler(m_buttonClose_MouseLeave);
        ...
        void m_buttonClose_MouseLeave(object sender, EventArgs e)
        {
            m_buttonClose.ForeColor = SystemColors.ControlText;
        }

        void m_buttonClose_MouseHover(object sender, EventArgs e)
        {
            m_buttonClose.ForeColor = Color.FromArgb(255, 255, 200, 138);
        }
        ...
        private InertButton ButtonWindowList
        {
            get
            {
                if (m_buttonWindowList == null)
                {
                    ...
                    m_buttonWindowList.MouseHover += m_buttonWindowList_MouseHover;
                    m_buttonWindowList.MouseLeave += m_buttonWindowList_MouseLeave;
        ...
        void m_buttonWindowList_MouseLeave(object sender, EventArgs e)
        {
            m_buttonWindowList.ForeColor = SystemColors.ControlText;
        }

        void m_buttonWindowList_MouseHover(object sender, EventArgs e)
        {
            m_buttonWindowList.ForeColor = Color.FromArgb(255, 255, 200, 138);
        }
		...
		private static string ToolTipClose
		{
			...
			{	
				if (_toolTipClose == null)
                    _toolTipClose = XiaoCai.WinformUI.Properties.Resources.DockPaneStrip_ToolTipClose;
		...
		private static string ToolTipSelect
		{
			...
			{	
				if (_toolTipSelect == null)
                    _toolTipSelect = XiaoCai.WinformUI.Properties.Resources.DockPaneStrip_ToolTipWindowList;
		...
		protected override void OnPaint(PaintEventArgs e)
		{
            ...
            BackColor = colorTable.MenuStripGradientBegin;//Modify by Agan
            #region Modify by Agan
		...
		private void DrawTabStrip_Document(Graphics g)
		{
            ...
            OfficeColorTable colorTable = StyleBuilderFactory.GetOffice2007ColorTable(StyleManager.Style);
            g.DrawLine(new Pen(colorTable.TabControlBorderColor), rectTabStrip.Left, rectTabStrip.Bottom - 1,
                rectTabStrip.Right, rectTabStrip.Bottom - 1);
		...
		private void DrawTabStrip_ToolWindow(Graphics g)
		{
            ...
            //g.DrawLine(new Pen(Color.Red), rectTabStrip.Left, rectTabStrip.Top,
             //   rectTabStrip.Right, rectTabStrip.Top);
