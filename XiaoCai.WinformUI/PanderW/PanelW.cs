...
namespace XiaoCai.WinformUI.Panels
{
    ...
    public partial class PanelW : BasePanel
    {
        ...
        [Description("A value indicating whether the panels captionbar border is displayed.")]
        [DefaultValue(true)]
        [Category("Behavior")]
        public bool ShowCaptionbarBorder
        {
            get { return this.m_bShowCaptionbarBorder; }
            set
            {
                if (value.Equals(this.m_bShowCaptionbarBorder) == false)
                {
                    this.m_bShowCaptionbarBorder = value;
                    this.Invalidate(true);
                }
            }
        }
		...
		/// <summary>
		/// Gets or sets a value indicating whether the controls caption professional colorscheme is the same then the PanderPanelWs
		/// </summary>
		[Description("Gets or sets a value indicating whether the controls caption professional colorscheme is the same then the PanderPanelWs")]
		[DefaultValue(false)]
		[Category("Behavior")]
		public bool ShowPanderPanelWProfessionalStyle
		{
			get { return this.m_bShowPanderPanelWProfessionalStyle; }
			set
			{
                if (value.Equals(this.m_bShowPanderPanelWProfessionalStyle) == false)
                {
                    this.m_bShowPanderPanelWProfessionalStyle = value;
                    this.Invalidate(false);
                }
			}
		}
        ...
        public override Rectangle DisplayRectangle
        {
            get
            {
                ...
                if (this.m_bShowCaptionbar == true||this.m_bShowCaptionbarBorder)//Mark by agan
                {
                    ...
                    if (this.Controls.Count > 0)
                    {
                        ...
                        else
                        {
                            ...
                            if (this.m_bShowCaptionbarBorder)
                            {
                                displayRectangle = new Rectangle(
                                    padding.Left + Constants.BorderThickness,
                                    padding.Top + Constants.BorderThickness,
                                    this.ClientRectangle.Width - padding.Left - padding.Right -
        ...
        protected override void OnPanelCollapsing(object sender, PanderStateChangeEventArgs e)
        {
        ...
        private static void DrawBorderNoCaption(
    Graphics graphics,
	...
	public class PanelDesignerActionList : DesignerActionList
	{
        ...
        public bool ShowCaptionbarBorder
        {
            get { return this.Panel.ShowCaptionbarBorder; }
            set { SetProperty("ShowCaptionbarBorder", value); }
        }
        /// <summary>
        /// Gets or sets a value indicating whether the controls background is transparent.
        /// </summary>
        ...
        public bool ShowPanderPanelWProfessionalStyle
		{
			get { return this.Panel.ShowPanderPanelWProfessionalStyle; }
			set { SetProperty("ShowPanderPanelWProfessionalStyle", value); }
		}
        /// <summary>
	    ...
	    public override DesignerActionItemCollection GetSortedActionItems()
	    {
			...
			actionItems.Add(
				new DesignerActionPropertyItem(
				"ShowPanderPanelWProfessionalStyle",
				"Show the PanderPanelWs professional colorscheme",
				GetCategory(this.Panel, "ShowPanderPanelWProfessionalStyle")));
            ...
            actionItems.Add(
              new DesignerActionPropertyItem(
              "ShowCaptionbarBorder",
              "Show the captionbar border ",
              GetCategory(this.Panel, "ShowCaptionbarBorder")));
	    ...
	    private PanelW Panel
	    {
			get { return (PanelW)this.Component; }
	    }
