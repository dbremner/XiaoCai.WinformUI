...
namespace XiaoCai.WinformUI.Panels
{
    ...
    public class BasePanel : ScrollableControl, IPanel
	{
        ...
        #region Events
		/// <summary>
		/// Occurs when the close icon in the caption of the panel or PanderPanelW is clicked. 
		/// </summary>
		[Description("Occurs when the close icon in the caption of the panel or PanderPanelW is clicked.")]
		public event EventHandler<EventArgs> CloseClick;
		/// <summary>
		/// Occurs when the expand icon in the caption of the panel or PanderPanelW is clicked. 
		/// </summary>
		[Description("Occurs when the expand icon in the caption of the panel or PanderPanelW is clicked.")]
		public event EventHandler<EventArgs> ExpandClick;
        /// <summary>
        /// Occurs when the panel or PanderPanelW expands.
        /// </summary>
        [Description("Occurs when the panel or PanderPanelW expands.")]
        public event EventHandler<PanderStateChangeEventArgs> PanelExpanding;
        /// <summary>
        /// Occurs when the panel or PanderPanelW collapse.
        /// </summary>
        [Description("Occurs when the panel or PanderPanelW collapse.")]
        public event EventHandler<PanderStateChangeEventArgs> PanelCollapsing;
        /// <summary>
        ...
        [DefaultValue(0)]
		[Category("Appearance")]
		public virtual XiaoCai.WinformUI.Panels.PanelStyle PanelStyle
		{
		...
		[Browsable(true)]
		[Category("Appearance")]
		public virtual XiaoCai.WinformUI.Panels.ColorScheme ColorScheme
		{
        ...
        /// </summary>
        [Description("Expand the panel or PanderPanelW")]
        [DefaultValue(false)]
        [Category("Appearance")]
        ...
        public virtual bool Expand
        {
            ...
            set
            {
                if (value.Equals(this.m_bExpand) == false)
                {
                    ...
                    {
                        OnPanelExpanding(this, new PanderStateChangeEventArgs(this.m_bExpand));
                    }
                    else
                    {
                        OnPanelCollapsing(this, new PanderStateChangeEventArgs(this.m_bExpand));
                    }
                }
            }
        }
		...
		/// <summary>
		/// Gets or sets a value indicating whether the expand icon in a Panel or PanderPanelW is visible.
		/// </summary>
		[Description("Gets or sets a value indicating whether the expand icon in a Panel or PanderPanelW is visible.")]
		[DefaultValue(false)]
		[Category("Appearance")]
        ...
        /// <summary>
		/// Gets or sets a value indicating whether the close icon in a Panel or PanderPanelW is visible.
        /// </summary>
        [Description("Gets or sets a value indicating whether the close icon in a Panel or PanderPanelW is visible.")]
        [DefaultValue(false)]
        [Category("Appearance")]
        ...
        protected virtual void OnPanelExpanding(object sender, PanderStateChangeEventArgs e)
        {
        ...
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">A PanderStateChangeEventArgs that contains the event data.</param>
        protected virtual void OnPanelCollapsing(object sender, PanderStateChangeEventArgs e)
        {
        ...
        /// <param name="image">The image that is displayed on a panel's caption.</param>
        /// <param name="rightToLeft">A value indicating whether control's elements are aligned to support locales using right-to-left fonts.</param>
        /// <param name="bIsClosable">A value indicating whether the PanderPanelW is closable</param>
            ...
            string strCaptionText)
        {
            ...
            //if the PanderPanelW not closable then the RectangleCloseIcon must be empty
        ...
        /// <summary>
        /// Gets the linear GradientBackBrush for flat PanderPanelW captions.
        /// </summary>
